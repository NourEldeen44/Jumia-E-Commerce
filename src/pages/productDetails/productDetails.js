...
function ProductDetails(props) {
  ...
  return (
    <>
      ...
      >
        <div
          class="border1 justify-content-center d-flex flex-row ps-3 pe-3 pt-5"
          style={{ width: "80%" }}
        >
                    ...
                    <div class="col-md-7">
                      ...
                      <div class="">
                        ...
                        <p class="text-start">
                          ...
                          >
                            Free delivery (you are saving EGP 10.83) to 6th of
                            October
                          </small>
                        </p>
                      </div>
                      ...
                      <div class="text-start pb-1 ">
                        ...
                        >
                          {" "}
                          You can now donate Saq El Odhya through Dar El Orman{" "}
                        </a>{" "}
                      </div>
                      <div class="text-start pb-1 ">
                        {" "}
                        ...
                        >
                          {" "}
                          10 Years Together - Celebrate With Us Until July 3{" "}
                        </a>{" "}
                      </div>
                    </div>
                  </div>
          ...
          <div
            class=" card border col-3 rounded"
            style={{
          ...
          >
            <div>
              ...
              >
                <div
                  class="text-start fw-bolder border-bottom pb-2"
                ...
                <div
                  class="text-start fw-normal border-bottom pb-2"
                ...
                <div class="text-start fw-bolder p-1">
                  {" "}
                ...
                <div>
                  ...
                  <div style={{ display: "flex", paddingTop: "10px" }}>
                    ...
                    <div style={{ width: "80%" }}>
                      ...
                      <p class="text-start" style={{ margin: "0" }}>
                        ...
                        >
                          Free delivery (you are saving EGP 10.83)
                        </small>
                      </p>
                      <p class="text-start" style={{ fontSize: "12px" }}>
                        {" "}
                  ...
                  <div style={{ display: "flex", paddingTop: "10px" }}>
                    ...
                    <div style={{ width: "80%" }}>
                      ...
                      >
                        14 days free return (except for underwear and personal
                        items) up to 30 days for defective products with
                        necessity for requesting a return within 24 hours from
                        the delivery date.{" "}
                        <a
                          href="#"
                          class="text-decoration-none "
            ...
            >
              <div style={{ textAlign: "start", width: "100%" }}>
                ...
                <div style={{ fontSize: ".75rem" }}>
                  <span style={{ fontWeight: "500" }}> 100% </span>Seller Score
                </div>
              </div>
            </div>
